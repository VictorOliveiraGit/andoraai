...
const Footer = () => {
  return (
    <footer className="bg-primary-foreground text-foreground mt-20">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-muted-foreground">Email: contato@andoraai.com.br</li>
              <li className="text-sm text-muted-foreground">Telefone: (11) 1234-5678</li>
              <li className="text-sm text-muted-foreground">Endereço: Rua Example, 123</li>
            </ul>
          </div>
          <div>
